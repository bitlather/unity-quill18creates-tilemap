...
[CustomEditor(typeof(TGMap9))] // <-- Makes it appear in unity editor when you click objects that have script TileMap4
public class TGMapInspector9 : Editor {
	...
	public override void OnInspectorGUI(){
		...
		if (GUILayout.Button ("Regenerate")) {
			TGMap9 tileMap = (TGMap9)target; // <-- target just exists :-)
			tileMap.BuildMesh();
		}
