...
[CustomEditor(typeof(TileMap5))] // <-- Makes it appear in unity editor when you click objects that have script TileMap4
public class TileMapInspector5 : Editor {
	...
	public override void OnInspectorGUI(){
		...
		if (GUILayout.Button ("Regenerate")) {
			TileMap5 tileMap = (TileMap5)target; // <-- target just exists :-)
			tileMap.BuildMesh();
		}
