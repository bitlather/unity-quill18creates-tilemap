...
[CustomEditor(typeof(TileMap6))] // <-- Makes it appear in unity editor when you click objects that have script TileMap4
public class TileMapInspector6 : Editor {
	...
	public override void OnInspectorGUI(){
		...
		if (GUILayout.Button ("Regenerate")) {
			TileMap6 tileMap = (TileMap6)target; // <-- target just exists :-)
			tileMap.BuildMesh();
		}
