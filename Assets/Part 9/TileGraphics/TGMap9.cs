...
// NOTE THE TUTORIAL GOT SCREWED UP BETWEEN 9 AND 10 SO THIS FOLDER ISN'T VERY USEFUL

// https://www.youtube.com/watch?v=ur1aVEcXUbY
// Unity 3d: TileMaps - Part 9 - Tile Data Structures
//   In video 9 (and maybe 10), we use a data structure for the map and improve performance for drawing tiles 
// https://www.youtube.com/watch?v=KmzEGIalB_U
// Unity 3d: TileMaps - Part 10 - Tile Data Structures
//   In video 10, we give each tile its own vertices (we do not share vertices) to somehow improve performance for rendering textures. We will send more vertices data but have less texture data.
...
public class TGMap9 : MonoBehaviour {
...
//		BuildTexture(); // NOTE quil18 deleted this at end of Tutorial 9 but then lost files at beginning of tutorial 10. This prevents unity from compiling so I commented it out.
	}
}
